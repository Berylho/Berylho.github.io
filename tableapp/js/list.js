...
function GetBooking() {
    let url = 'https://api.sheety.co/9a9caed8a5606c2e414b15a80334954b/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/9a9caed8a5606c2e414b15a80334954b/bookingApp/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
